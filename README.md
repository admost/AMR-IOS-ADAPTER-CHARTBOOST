![AMRAdapterChartboost: Admost Mediation iOS SDK](https://www.admost.com/img/logo.svg)
...
[![CocoaPods Compatible](https://img.shields.io/cocoapods/v/AMRAdapterChartboost.svg?style=flat-square)](https://img.shields.io/cocoapods/v/AMRAdapterChartboost.svg)
...
Chartboost adapter for AMRSDK. Allows publishers to mediate Chartboost interstitial and video ads in AMRSDK.
...
```
https://github.com/admost/AMR-IOS-ADAPTER-CHARTBOOST.git
```
